...
declare -a TPS_PER_WORKER=(1000 8000 16000 24000 32000 40000 48000 56000 64000)
declare -i NUM_WORKER=4
declare -i DURATION=180
declare -i WARM_DURATION=0
declare APP=q5
declare -i FLUSH_MS=100
declare -i SRC_FLUSH_MS=100
declare -i SNAPSHOT_S=10
declare -i COMM_EVERY_MS=100
declare -a modes=(align_chkpt epoch 2pc none)
